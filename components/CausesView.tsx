    ...
    <div className="page active">
      <div className="inner-hero">
        ...
        <div className="inner-hero-content">
          ...
          <h1 className="inner-hero-title uppercase">Chaque Enfant<br />Mérite un Avenir</h1>
      ...
      <section className="bg-mesh-light" style={{ padding: "100px 0", position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ textAlign: "center", maxWidth: 800, margin: "0 auto", marginBottom: 64 }}>
            ...
            <h2 className="uppercase" style={{ fontSize: "48px", color: "var(--navy-primary)", fontFamily: "var(--font-cormorant)", fontWeight: 400 }}>Pourquoi nous existons</h2>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 32 }}>
            <div style={{ padding: 40, background: "var(--white)", borderRadius: 0, borderTop: "4px solid var(--gold)", boxShadow: "0 10px 30px rgba(0,0,0,0.03)" }}>
              ...
              <h3 className="uppercase" style={{ fontSize: 24, fontWeight: 500, marginBottom: 16, color: "var(--navy-primary)", fontFamily: "var(--font-cormorant)", minHeight: "60px" }}>Évoluer vers un impact mondial</h3>
            ...
            <div style={{ padding: 40, background: "var(--white)", borderRadius: 0, borderTop: "4px solid var(--crimson)", boxShadow: "0 10px 30px rgba(0,0,0,0.03)" }}>
              ...
              <h3 className="uppercase" style={{ fontSize: 24, fontWeight: 500, marginBottom: 16, color: "var(--navy-primary)", fontFamily: "var(--font-cormorant)", minHeight: "60px" }}>Protéger et promouvoir les droits</h3>
              <p style={{ fontSize: 15, color: "#6B7280", lineHeight: 1.7 }}>
            ...
            <div style={{ padding: 40, background: "var(--white)", borderRadius: 0, borderTop: "4px solid var(--navy-primary)", boxShadow: "0 10px 30px rgba(0,0,0,0.03)" }}>
              ...
              <h3 className="uppercase" style={{ fontSize: 24, fontWeight: 500, marginBottom: 16, color: "var(--navy-primary)", fontFamily: "var(--font-cormorant)", minHeight: "60px" }}>Impartialité & Neutralité</h3>
              <p style={{ fontSize: 15, color: "#6B7280", lineHeight: 1.7 }}>
      ...
      <section className="bg-mesh-dark" style={{ padding: "100px 0" }}>
        <div className="container">
          <div style={{ textAlign: "center", maxWidth: 700, margin: "0 auto", marginBottom: 64 }}>
            ...
            <h2 className="uppercase" style={{ fontSize: 48, color: "#fff", marginBottom: 24, fontFamily: "var(--font-cormorant)", fontWeight: 400 }}>Ce que votre don finance</h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: 24, maxWidth: "1000px", margin: "0 auto" }}>
            <div style={{ padding: 32, background: "rgba(255,255,255,0.03)", borderRadius: 16, border: "1px solid rgba(255,255,255,0.05)", display: "flex", gap: 24 }}>
              ...
              <div>
                <h3 className="uppercase" style={{ color: "#fff", fontSize: 18, fontWeight: 600, marginBottom: 8, fontFamily: "var(--font-cormorant)" }}>Éducation</h3>
            ...
            <div style={{ padding: 32, background: "rgba(255,255,255,0.03)", borderRadius: 16, border: "1px solid rgba(255,255,255,0.05)", display: "flex", gap: 24 }}>
              ...
              <div>
                <h3 className="uppercase" style={{ color: "#fff", fontSize: 18, fontWeight: 600, marginBottom: 8, fontFamily: "var(--font-cormorant)" }}>Santé</h3>
            ...
            <div style={{ padding: 32, background: "rgba(255,255,255,0.03)", borderRadius: 16, border: "1px solid rgba(255,255,255,0.05)", display: "flex", gap: 24 }}>
              ...
              <div>
                <h3 className="uppercase" style={{ color: "#fff", fontSize: 18, fontWeight: 600, marginBottom: 8, fontFamily: "var(--font-cormorant)" }}>Plaidoyer</h3>
            ...
            <div style={{ padding: 32, background: "rgba(255,255,255,0.03)", borderRadius: 16, border: "1px solid rgba(255,255,255,0.05)", display: "flex", gap: 24 }}>
              ...
              <div>
                <h3 className="uppercase" style={{ color: "#fff", fontSize: 18, fontWeight: 600, marginBottom: 8, fontFamily: "var(--font-cormorant)" }}>Réinsertion sociale</h3>
      ...
      <section style={{ background: "var(--crimson)", padding: "100px 0", textAlign: "center" }}>
        <div className="container">
          <h2 className="uppercase" style={{ fontSize: 48, color: "#fff", marginBottom: 24, fontFamily: "var(--font-cormorant)", fontWeight: 400, lineHeight: 1.2 }}>
