...
export const ProgrammesView = ({ goTo }: { goTo: (page: string) => void }) => {
  const programmes = [
    ...
    { tag: "Égalité & Genre", color: "gold", title: "Orphans Gender", desc: "Égalité de genre, protection des droits des filles et garçons, lutte contre les discriminations. Sensibilisation sur l'hygiène menstruelle en milieu rural.", img: "/component_pictures/programmes/egalite.jpeg", slug: "orphans-gender" },
    { tag: "Communication", color: "crimson", title: "Orphans Magazine", desc: "Communication, sensibilisation et rayonnement de la cause humanitaire à travers les médias. Promotion des activités et de l'image de l'organisation.", img: "/component_pictures/programmes/comm.jpeg", slug: "orphans-magazine" },
